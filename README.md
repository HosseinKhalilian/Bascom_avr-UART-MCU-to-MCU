...
A key is connected to the first MCU and an LED is connected to the second MCU.
The first MCU receives the status of the key and send it to the second MCU and the second MCU changes the state of the LED according to the received data.
...
<p align="center">
<a href="./LICENSE.md">
<img alt="GitHub license" src="https://img.shields.io/github/license/khalilian-ah/Bascom_avr-UART-MCU-to-MCU?style=badge">
</a>
